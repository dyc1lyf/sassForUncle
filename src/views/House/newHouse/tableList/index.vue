            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <el-tooltip placement="top-start">
                        ...
                        <span class="table_ellipsis color-brand" @click="handleEdit(scope.$index, scope.row)">{{scope.row.long_title}}</span>
                    </el-tooltip>
                </template>
            </el-table-column>
...
export default {
    ...
    methods: {
        ...
        getListData() {
            ...
            util.ajax.post("/api/Newsapi/house_list",this.listQuery).then(
                res=>{
                    if(res.errcode == 0){
        ...
        handleExamine(index, row){
            this.$router.push({path: './house/details', query: {id: row.id}});
        },
        // 删除操作
