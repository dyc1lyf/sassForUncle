        ...
        <div class="infoBlock">
            ...
            <div class="editInfoMain">
                <el-form
                    ...
                    <div class="infoRow flex">
                        ...
                        <el-form-item prop="area" label="出租面积">
                            <el-input
                                class="w268"
                                :value="formData.area"
                    ...
                    <!-- 租金、付款方式、出租方式 -->
                    <div class="infoRow flex">
                        <el-form-item prop="price" label="租金">
                            <el-input
                                class="w268"
                                :value="formData.price"
                                @input="e => formData.price = noChineseOnly (e,5,true)"
                                placeholder="请输入租金"
                            >
                        ...
                        <el-form-item label="出租方式"> 
                            <el-select v-model="formData.rent_model" placeholder="请选择" class="w268">
                                <el-option
                        ...
                        <el-form-item label="付款方式">
                            <el-select v-model="formData.payment" placeholder="请选择" class="w268">
                                <el-option
                    ...
                    <div class="infoRow flex">
                        <el-form-item label="装修情况">
                            <el-select v-model="formData.decoration" placeholder="请选择" class="w268">
                                <el-option
            ...
            <div class="editInfoMain">
                ...
                >
                    ...
                    <!-- 卧室设备 -->
                    <div class="infoRow flex">
                        <el-form-item label="卧室设备" class="w63per">
                            <el-checkbox-group v-model="formData.bedroom_equipment" > 
                                <el-checkbox :label="item.id" v-for="item in demandData.Supporting" :key="item.id">{{item.value}}</el-checkbox>
                            </el-checkbox-group>
                        </el-form-item>
                    </div>
                    <!-- 公共设备 --> 
                    <div class="infoRow flex">
                        <el-form-item label="公共设备" class="w63per">
                            <el-checkbox-group v-model="formData.communal_facilities" >
                                <el-checkbox :label="item.id" v-for="item in demandData.communal_facilities" :key="item.id">{{item.value}}</el-checkbox>
                            </el-checkbox-group>
                        </el-form-item>
                    </div>
                </el-form>
...
export default {
  ...
  data() {
    return {
        loading: false,
        videoFlag: false,
        getDemandDataValue: 'towards,heating,decoration,housing_use,property_right,manner,payment,features,Supporting,communal_facilities,floor',
        isLoading: false,
        // 行政区列表
        areaArr: [],
        villageArr: [],
        ...
        formData: {
            ...
            property_right: "", //房屋年限
            features: [], //特色id
            bedroom_equipment: [], //卧室设施
            communal_facilities: [], //公共设施
            broker_id:"", //维护人ID
            true_name:"", //维护人姓名
            phone_number:"", //维护人电话
            cname: "", //业主
  ...
  methods: {
    ...
    getDataInfo(id){
        if (id) {
            util.ajax.post('/api/Newsapi/edit', {hid: id,type: '1'}).then(res => {
                if (res.errcode == 0) {
    ...
    submitForm() {
        ...
        if (this.formData.area=="") return this.$message({message: '出租面积不能为空',type: "warning"});
        if (this.formData.towards=="") return this.$message({message: '房屋朝向不能为空',type: "warning"});
        if (this.formData.price=="") return this.$message({message: '租金不能为空',type: "warning"});
        if (this.formData.rent_model=="") return this.$message({message: '出租方式不能为空',type: "warning"});
        if (this.formData.payment=="") return this.$message({message: '付款方式不能为空',type: "warning"});
        ...
        oRequest.bedroom_equipment = oRequest.bedroom_equipment.join(',')
        oRequest.communal_facilities = oRequest.communal_facilities.join(',')
