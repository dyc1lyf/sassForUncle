        ...
        <div class="container">
            <div class="info-content information">
                ...
                <div class="editInfoMain">
                    <el-form class="form-box" label-position="left">
                        ...
                        <el-row>
                            ...
                            <el-col :span="12" v-if="data.comm">
                                <el-form-item label="地址：">
                                    <div>{{data.address?data.address:'暂无数据'}}</div>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <!-- 标题 -->
                        ...
                        <el-row>
                            ...
                            <el-col :span="24">
                                <el-form-item label="描述：">
                                    <span>{{data.description?data.description:'暂无数据'}}</span>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <!-- 居室、朝向 -->
                        ...
                        <el-row>
                            ...
                            <el-col :span="12">
                                <el-form-item label="套内面积：">
                                    <span>{{data.unit_price?data.unit_price+"㎡":'暂无数据'}}</span>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <!-- 总价、单价 -->
                        <el-row>
                            ...
                            <el-col :span="12">
                                <el-form-item label="总价：">
                                    <span>{{data.total_price?data.total_price+"元":'暂无数据'}}</span>
                                </el-form-item>
                            </el-col>
                            <!-- 单价 -->
                            <el-col :span="12">
                                <el-form-item label="单价：">
                                    <span>{{data.unit_price?data.unit_price+"元":'暂无数据'}}</span>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <!-- 装修状况、供暖方式 -->
                        ...
                        <el-row>
                            ...
                            <!-- 是否有车库 -->
                            <el-col :span="12" v-if="data.comm">
                                <el-form-item label="是否有车库：">
                                    <span>{{data.comm.is_carts==1?'有':'无'}}</span>
                                </el-form-item>
                            </el-col>
                        </el-row>
                    </el-form>
                ...
                <div class="editInfoMain">
                    <el-form class="form-box" label-position="left">
                        <!-- 房屋用途、房屋权属 -->
                        <el-row v-if="data.field">
                            <!-- 房屋用途 -->
                            <el-col :span="12">
                                <el-form-item label="房屋用途：">
                                    <span v-for="(item,index) in data.field.housing_use" :key="item.id">{{index>0?"、"+item.value:item.value}}</span>
                                </el-form-item>
                            </el-col>
                            <!-- 房屋权属 -->
                            <el-col :span="12">
                                <el-form-item label="房屋权属：">
                                    <span v-for="(item,index) in data.field.years" :key="item.id">{{index>0?"、"+item.value:item.value}}</span>
                                </el-form-item>
                            </el-col>
                        </el-row>
                    </el-form>
                        ...
                        <el-row>
                            ...
                            <el-col :span="12">
                                <el-form-item label="核心卖点：">
                                    <span>{{data.selling_point?data.selling_point:'暂无数据'}}</span>
                                </el-form-item>
                            </el-col>
                        </el-row>
                    </el-form>
        ...
        methods: {
            grouplist() {
                if (this.$route.query.id) {
                    util.ajax.post('/api/Newsapi/house_info', {hid: this.$route.query.id,type: '2'}).then(res => {
                        if (res.errcode == 0) {
            ...
            resetForm() {
                this.$router.push({path: '/cooperation/secondHouse'});
            },
            // 处理视频问号
            isPic(data){
                if(data){
