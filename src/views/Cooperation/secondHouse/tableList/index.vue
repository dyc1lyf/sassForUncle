<template>
    <div>
        ...
        >
            ...
            <el-table-column label="特色" prop="tags" align="center"></el-table-column>
            <el-table-column label="房源维护人" prop="true_name" align="center" width="100">
            </el-table-column>
        </el-table>
...
export default {
    ...
    methods: {
        ...
        getListData() {
            ...
            util.ajax.post("/api/Newsapi/p_list",params).then(
                res=>{
                    if(res.errcode == 0){
        ...
        handleExamine(index, row){
            this.$router.push({path: '/cooperation/secondHouse/details', query: {id: row.id}});
        },
        // 分页导航
